...
const staticFaq: FaqEntry[] = [
  { id: 1, question: 'Comment puis-je créer un compte <img src="/brand/orzayah-logo.png" alt="ORZAYAH" className="inline-block h-5 w-auto align-middle" /> ?', answer: 'Créer un compte <img src="/brand/orzayah-logo.png" alt="ORZAYAH" className="inline-block h-5 w-auto align-middle" /> est simple et rapide. Téléchargez l\'application, entrez votre numéro de téléphone, vérifiez votre identité avec une pièce d\'identité valide, et vous êtes prêt. Le processus prend moins de 5 minutes.', category: 'Compte' },
  ...
  { id: 4, question: 'Est-ce que <img src="/brand/orzayah-logo.png" alt="ORZAYAH" className="inline-block h-5 w-auto align-middle" /> est sécurisé ?', answer: 'Oui, la sécurité est notre priorité. Nous utilisons le chiffrement AES-256, l\'authentification biométrique, et la vérification en deux étapes pour protéger votre compte.', category: 'Sécurité' },
      ...
      <section className="bg-gradient-to-b from-primary-50 to-white py-16">
        <div className="container text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Trouvez rapidement les réponses à vos questions sur <img src="/brand/orzayah-logo.png" alt="ORZAYAH" className="inline-block h-5 w-auto align-middle" /> et nos services.
          </p>
        ...
        <div className="container max-w-3xl">
          ...
          <div className="mt-12 text-center p-8 bg-gradient-to-br from-primary-50 to-emerald-50 rounded-2xl border border-primary-100">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a href="mailto:info@<img src="/brand/orzayah-logo.png" alt="ORZAYAH" className="inline-block h-5 w-auto align-middle" />-ci.com"
